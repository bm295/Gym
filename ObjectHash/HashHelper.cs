...
namespace ObjectHash
{
    ...
    {
        /// <summary>
        /// for custome class need [Serializable]
        /// to ignore https://stackoverflow.com/questions/33489930/ignore-non-serialized-property-in-binaryformatter-serialization
        /// </summary>
        ...
        public byte[] Hash(byte[] value)
        {
            ...
            /*https://andrewlock.net/why-is-string-gethashcode-different-each-time-i-run-my-program-in-net-core/S*/
