...
builder.Services.AddSingleton<IAuditEntryRepository, InMemoryAuditEntryRepository>();
builder.Services.AddSingleton<ITenantReportQuery, InMemoryTenantReportQuery>();
